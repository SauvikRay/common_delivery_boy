...
import 'package:font_awesome_flutter/font_awesome_flutter.dart';import 'package:toast/toast.dart';

import '../custom/toast_component.dart';
import '../dummy_data/orders_data.dart';
import '../helpers/shimmer_helper.dart';
import '../helpers/sortable.dart';
import '../my_theme.dart';
import '../other_config.dart';
import '../repositories/delivery_repository.dart';
import '../ui_sections/drawer.dart';
import 'order_details.dart';
import 'single_order_map.dart';
...
class _OnTheWayDeliveryState extends State<OnTheWayDelivery> {
  ...
  Container buildPaymentStatusCheckContainer(String payment_status) {
    return Container(
      ...
      child: Padding(
        ...
        child: Icon(
            payment_status == "paid" ? FontAwesomeIcons.check : FontAwesomeIcons.xmark,
            color: Colors.white,
            size: 10),
      ),
    );
  ...
  Container buildCheckContainer() {
    return Container(
      ...
      child: Padding(
        padding: const EdgeInsets.all(3),
        child: Icon(FontAwesomeIcons.check, color: Colors.white, size: 12),
      ),
    );
  }
